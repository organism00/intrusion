...
$Username = $_GET['id'];
$sql = "SELECT * FROM olosho WHERE OloshoID = '$Username'";
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="image">
                      ...
                      <?php
                  $query = "SELECT * FROM olosho WHERE OloshoID = '$Username'";
                      $show = mysqli_query($conn, $query);
                    while($Row = mysqli_fetch_array($show))
                    {
                      ?>
                      <form method="POST" enctype='multipart/form-data'>
                      <img  src="<?php echo $Row['images'] ?>" style="width:180px;height:170px" class="img-circle elevation-2" alt="User Image"><br><br>
