...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="students.php" class="nav-link">Back</a></li>
    </ul>
                ...
                <div class="row">
                  ...
                  $query = "SELECT * FROM student WHERE matricno = '$Username'";
                    ...
                    while($Row = mysqli_fetch_array($show))
                    {
                      ...
                      <img  src="<?php echo $Row['images']?>" style="width:150px;height:150px; border:2px solid;"  alt="User Image"><br><br>
                      ...
                      <input type="text" class="form-control" name="department" value="<?php echo $Row['department']?>"/><br>
                      
                       
                          <label>GradeLevel</label>
                          <input type="text" class="form-control" name="gradelevel" value="<?php echo $Row['gradelevel']?>"/>
                        <br>
  ...
  <strong>Copyright &copy; 2020 <a href="">LASPOTIAN</a>.</strong>
    All rights reserved.
